...
PROMPT = '''Você é um chatbot amigável que auxilia na interpretação de documentos que lhe são fornecidos.
...
Se você não sabe como responder, diga que não sabe a resposta e não tente inventar.
